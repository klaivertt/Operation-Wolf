...
void LoadHealthBar()
{
	...
	healthBarContainer.texture = sfTexture_createFromFile("Assets/Sprites/Game/HUD/TimeContainer.png", NULL);
	healthBar.texture = sfTexture_createFromFile("Assets/Sprites/Game/HUD/TimeBar.png", NULL);
